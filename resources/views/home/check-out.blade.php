                            ...
                            <ul>
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="check-out.html" class="active">Check Out Page</a></li>
                                    </ul>
                                </li>
                ...
                <form action="#" class="form">
                    <div class="row gutter-lg">
                                ...
                                <div class="bg-white mb-3">
                                    ...
                                    <div class="cal-body p-4">
                                        ...
                                        <div class="form-checkbox mb-6">
                                            ...
                                            <label class="form-control-label" for="different-address">Ship to a different address?</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-white mb-3">
                                    <div class="cal-title px-4 py-3 bg-title">
                        ...
                        <aside class="col-lg-5">
                            <div class="checkout-area-right">
                                <div class="order-table bg-white mb-3">
                                    <div class="car-right-title px-4 py-3 bg-title">
                                        <h4 class="mb-0">Order Review</h4>
                                    </div>
                                    <div class="car-right-body p-4">
                                        <div class="list-product-check">
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                ...
                                <div class="payment bg-white">
                                    ...
                                    <div class="car-right-body p-4">
                                        <ul class="navbar-nav">
                                            <li class="nav-item">
                                                <div class="custom-radio">
                                                    <input type="radio" id="paycard" name="paycard" class="custom-control-input" checked="">
                                                    <label class="custom-control-label" for="paycard">Debit/credit card or Mobile wallet (Rocket, Upay, iPay, SureCash, OK wallet)</label>
                                                </div>
                                            </li>
                                            <li class="nav-item">
                                                <div class="custom-radio">
                                                    <input type="radio" id="paycard2" name="paycard" class="custom-control-input">
                                                    <label class="custom-control-label" for="paycard2">bKash</label>
                                                </div>
                                            </li>
                                            <li class="nav-item">
                                                <div class="custom-radio">
                                                    <input type="radio" id="paycard3" name="paycard" class="custom-control-input">
                                                    <label class="custom-control-label" for="paycard3">Cash on delivery</label>
                                                </div>
                                            </li>
                                        </ul>
                                        <hr>
                                        <p class="per-information">Your personal data will used to process your order, support your experience throughout this website, and for other purposes described in our privacy policy.</p>
                                        <button type="submit" class="default-btn move-right"><span>Place Order</span></button>
                                    </div>
                                </div>
                            </div>
                        </aside>
