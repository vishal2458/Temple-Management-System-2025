                            ...
                            <ul>
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="cart.html" class="active">Cart Page</a></li>
                ...
                <div class="cart-bottom">
                    <div class="cart-checkout-box">
                        <form class="coupon" action="/">
                            ...
                            <button type="submit" class="default-btn move-right ms-2 px-4"><span>Apply</span></button>
                        </form>
                        <form class="cart-checkout" action="/">
                            <button type="submit" class="default-btn move-right m-2"><span>Update Cart</span></button>
                            <button type="submit" class="default-btn move-right m-2"><span>Proceed to Checkout</span></button>
                        </form>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="calculate-shiping">
                                    ...
                                    <button type="submit" class="default-btn move-right"><span>Update Total</span></button>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
