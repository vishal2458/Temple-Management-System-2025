...
<body>
    ...
    <div class="forezero padding--top padding--bottom">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-12">
                    <div class="forezero__content text-center">
                        <h2>404</h2>
                        <p>SOMETHING IS WRONG</p>
                        <span>The page you are looking for was moved, removed, renamed or might never existed.</span>
                        <div class="forezero__form">
                            <form method="get" action="#">
                                <input type="search" placeholder="Type and Hit Enter ...">
                                <button type="submit" class="add-on"><i class="fas fa-search"></i></button>
                            </form>
                            <a href="index.html" class="default-btn move-right"><span>GO BACK HOME</span></a>
                        </div>
                    </div>
                </div>
            </div>
