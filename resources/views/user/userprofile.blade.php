              ...
              <div class="profile-widget-header">
                ...
                <div class="profile-widget-items">
                  ...
                  <div class="profile-widget-item">
                    ...
                    <div class="profile-widget-item-value"><i class="fas fa-rupee-sign"></i> {{ $totalAmount }}</div>
                  </div>
                  ...
                  <div class="card-body">
                        ...
                        <div class="row" id="adharcard-fields" style="display: none">
                          ...
                          <div class="form-group col-md-6 col-12">
                            ...
                            <input type="file" class="form-control" id="adhar_img" name="adhar_img" value="{{ $user->userDetails->adhar_card_image ?? null }}">
                        ...
                        <div class="row" id="pancard-fields" style="display: none">
                          ...
                          <div class="form-group col-md-6 col-12">
                            ...
                            <input type="file" class="form-control" id="pancard_img" name="pancard_img" value="{{ $user->userDetails->pan_card_image ?? null }}">
  ...
  $(document).ready(function () {
    ...
    $('#necessary_details_form').validate({
        rules: {
            ...
            adhar_img: {
                required: function () {
                    let existingImage = "{{ $user->userDetails->adhar_card_image ?? '' }}"; // Get the existing image value
                    let uploadedImage = $('#adhar_img').val(); // Get the uploaded file

                    return !existingImage && !uploadedImage; // Validate only if no existing image AND no new upload
                },
                fileExtension: "jpg|jpeg|png|pdf",
            },
            Pancard_img: {
                required: function () {
                    let existingImage = "{{ $user->userDetails->pan_card_image ?? '' }}"; // Get the existing image value
                    let uploadedImage = $('#pancard_img').val(); // Get the uploaded file
            ...
            passport_img: {
                required: function () {
                    let existingImage = "{{ $user->userDetails->passport_image ?? '' }}"; // Get the existing image value
                    let uploadedImage = $('#passport_img').val(); // Get the uploaded file
